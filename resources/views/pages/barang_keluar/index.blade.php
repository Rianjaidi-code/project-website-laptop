                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="float-right">
                                    <form method="GET" action="{{ route('data-laptop.index', $barangKeluars) }}">
                                ...
                                <div class="button-action" style="margin-bottom: 20px">
                                    ...
                                    <a href="{{ Route('barang-keluar.create') }}" class="btn btn-primary ml-2">
                                        Tambah Data </a>
                                ...
                                <div class="table-responsive">
                                    <table class="table-striped table" style="width: 100%;">
                                        <tr>
                                            ...
                                            <th style="width: 100px;">Tgl. out</th>
                                            <th style="width: 100px;">Action</th>
                                        </tr>
                                        @foreach ($barangKeluars as $barangkeluar)
                                            <tr>

                                                <td>{{ $barangkeluar->user->name }}
                                                </td>
                                                <td>
                                                    {{ $barangkeluar->barang->model }}
                                                </td>
                                                <td>
                                                    {{ $barangkeluar->status }}
                                                </td>
                                                ...
                                                <td>
                                                    {{ $barangkeluar->created_at->format('Y-m-d') }}
                                                </td>
                                                <td>

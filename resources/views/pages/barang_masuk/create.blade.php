                        ...
                        <table id="dataTable" class="table-striped table" style="width: 800px;">
                            ...
                            <tbody>
                                @foreach ($barangMasuks as $barangMasuk)
                                    <tr>
                                        <td>{{ $barangMasuk->no_sample }}</td>
                                        <td>{{ $barangMasuk->model }}</td>
                                        <td>{{ $barangMasuk->condition_notes }}</td>
                                        <td>
                                            <div class="d-flex justify-content-center">
                                                <button type="button" class="btn btn-sm btn-info btn-icon select-item"
                                                    data-id="{{ $barangMasuk->id }}"
                                                    data-sample="{{ $barangMasuk->no_sample }}"
                                                    data-model="{{ $barangMasuk->model }}"
                                                    data-condition="{{ $barangMasuk->condition_notes }}">
